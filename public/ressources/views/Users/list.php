...
<h4 id="titre" class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
  ...
  <div class="w-full overflow-hidden rounded-lg shadow-xs">
    <div  class=" grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800" >
      <span id="affichage" class="flex items-center col-span-3">
      </span> 
      ...
      <div class="w-full whitespace-no-wrap container mx-auto ">
        ...
        <div class="table-header-group">
          ...
          <div class="table-row flex text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
            ...
            <!-- columns -->
            <div class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700" style="width: 16.6667%;">Id</div>
